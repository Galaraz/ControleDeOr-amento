...
<div>
    ...
    <div class="row">
        <div class="col">
            ...
            <Widget
                title="<h5><i class='far fa-list-alt text-primary'></i> Lista de Clientes</h5>"
...
export default {
    ...
    methods: {
        ...
        getRegisters(page = 1){ 
            ...
            this.$http({
                method: 'get',
                url: process.env.VUE_APP_URL_BASE_API+'/api/cad/clientes?page=' + page,
            })
            .then(result => {
        ...
        processRegistry(){
            ...
            if(this.registry.action=='U'){
                this.$http({
                    method: 'patch',
                    url: process.env.VUE_APP_URL_BASE_API+'/api/cad/clientes',
                    data: this.registry
                })
                .then( () => {
                    this.processando = false
                ...
                bodyFormData.append("nome_fantasia", this.registry.nome_fantasia); 
    ...
    created(){
        ...
        this.$store.commit('setNomePagina', '<i class="fas fa-cogs"></i>&nbsp;Cadastros&nbsp;&nbsp;&nbsp;<i class="fas fa-angle-right"></i>&nbsp;&nbsp;&nbsp;<i class="fas fa-truck"></i>&nbsp;clientes')
