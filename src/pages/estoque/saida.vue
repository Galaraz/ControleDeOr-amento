...
<!-- <b-alert show variant="warning"><i class="fas fa-exclamation-triangle"></i> Em Validação.</b-alert> -->
    <div class="row">
            ...
            >
                ...
                <div class="row">
                    <div class="col text-center">
                        <b-button style="width: 10rem;" size="lg" variant="primary" v-b-tooltip.hover title="Salvar Saída do Equipamento" @click="materialSaida()"><i class="fas fa-sign-out-alt"></i></b-button>
                    </div>
                </div>
        ...
        <div class="col col-6">
            <b-overlay variant="white" spinner-variant="primary" :show="processando" rounded="sm" style="width:100%">
            <Widget
                title="<h5>&nbsp;&nbsp;<i class='fas fa-list-ol text-primary'></i>&nbsp;&nbsp;Saídas Efetuadas</h5>"
                customHeader
                bodyClass="p-0"
            >
...
export default {
    ...
    methods: {
        ...
        materialSaida(){
            ...
            if(parseFloat(this.material.qtd)>this.material.qtd_estoque){
                alert("Quantidade de saída maior que a do estoque.")
                this.$refs.focusQtd.$el.focus()
                return
            }
            ...
            //     this.processando = false
            //     // console.log(this.material)
            //     this.materiais_saida.splice(0, 0, this.material)
            //     // this.materiais_saida.push(this.material)
            //     // alert("splice feito")
            //     // console.log(this.materiais_saida);
            //     this.material = {}
            //     this.focusID()
            // }, 1000);
            ...
            this.$http({
                method: 'post',
                url: process.env.VUE_APP_URL_BASE_API + "/api/estoque/saida",
                data: bodyFormData
            })
            .then(() => {
                this.processando = false;
